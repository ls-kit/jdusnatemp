...
<div class="main-wrapper">
    ...
    <div class="header-section section">
        ...
        <!-- Header Top Start -->
        <div class="header-top header-top-two bg-theme-one">
            <div class="container-fluid">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col mt-10 mb-10">
                        ...
                        <ul class="header-lan-curr header-lan-curr-two">
        ...
        <div class="container">
            <div class="row mbn-40">
                ...
                <div class="col-lg-4 col-md-6 col-12 order-1 order-md-2 mb-40">
                    ...
                    <div class="row">
                        <div class="section-title text-start col col mb-30">
                            <h1>BEST DEAL</h1>
                ...
                <div class="col-lg-8 col-md-6 col-12 pe-3 pe-lg-4 pe-xl-5 order-2 order-md-1 mb-40">
    ...
    <div class="testimonial-section section section-padding pt-0">
        <div class="container">
            ...
            <div class="testimonial-slider slick-space d-flex">
...
`
    ...
    <div class="feature-section section section-padding pt-0 fix">
        <div class="container-fluid">
    ...
    <div class="footer-top-section section section-padding bg-theme-one-light">
        <div class="container">
            <div class="row mbn-40">
        ...
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    <p class="footer-copyright">© 2022 Jadusona. Made with <i class="fa fa-heart heart-icon text-dark"></i> By <a target="_blank" href="https://hasthemes.com">HasThemes</a></p>
                </div>
            </div>
        </div>
